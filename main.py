...
if args.dataset == "Cora" or args.dataset == "CiteSeer" or args.dataset == "PubMed":
    ...
    if args.dataset == "Cora":
        ...
        model = JKA_NDC_two_layer(dataset.num_features, args.hidden_dim, dataset.num_classes, args.dropout).to(device)
        ...
        model = JKA_NDC_three_layer(dataset.num_features, args.hidden_dim, dataset.num_classes, args.dropout).to(
            device)
        run(dataset, model, args.runs, args.epochs, args.lr, args.weight_decay, args.early_stopping, args.alpha,
            args.tau,
    ...
    if args.dataset == "photo":
        ...
        model = JKA_NDC_four_layer(dataset.num_features, args.hidden_dim, dataset.num_classes, args.dropout).to(device)
        run(dataset, model, args.runs, args.epochs, args.lr, args.weight_decay, args.early_stopping, args.alpha,
            args.tau,
